...
${project.name}
  ...
  The DOAP Plugin is used to generate a compliant {{{http://usefulinc.com/doap}Description of a Project (DOAP)}}
...
* Usage
  ...
  General instructions on how to use the DOAP Plugin can be found on the {{{./usage.html}usage page}}. Some more
  specific use cases are described in the examples given below. Last but not least, users occasionally contribute
  additional examples, tips or errata to the
  {{{http://docs.codehaus.org/display/MAVENUSER/DOAP+Plugin}plugin's wiki page}}.
...
* Examples
  ...
  * {{{./examples/with-site-plugin.html}Integrate DOAP Plugin in the Site Plugin}}
